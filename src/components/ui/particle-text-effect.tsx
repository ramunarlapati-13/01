...
export function ParticleTextEffect({ words = DEFAULT_WORDS, fontSize = 100 }: ParticleTextEffectProps) {
    ...
    const nextWord = (word: string, canvas: HTMLCanvasElement) => {
        ...
        // Generate new color from theme palette
        const themeColors = [
    ...
    const animate = (time: number) => {
        ...
        // Auto-advance words based on time (4 seconds)
        if (time - lastTimeRef.current > 4000) {
